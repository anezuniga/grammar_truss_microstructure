...
from openscad.generate_openscad_file import create_scad_file
...
filename_lattice = f'{folder_json}/truss_{seed}_lattice.json' 
...
generate_json(format_vertices(vertices_lattice), format_edges(edges_lattice), filename_lattice)

# Save Openscad file
folder_openscad = 'openscad/scripts'
if not os.path.exists(folder_openscad):
    os.makedirs(folder_openscad)
filename_openscad_octant = f'{folder_openscad}/truss_{seed}_octant.scad' 
filename_openscad_unit = f'{folder_openscad}/truss_{seed}_unit.scad'
create_scad_file(vertices_octant, edges_octant, thickness, thickness, filename_openscad_octant)
create_scad_file(vertices_unit, edges_unit, thickness, thickness, filename_openscad_unit)